...
export function createLocalApi(rpcClient: WsRpcClient): LocalApi {
  return {
    ...
    server: {
      ...
      listLinearAccounts: rpcClient.server.listLinearAccounts,
      createLinearAccount: rpcClient.server.createLinearAccount,
      updateLinearAccount: rpcClient.server.updateLinearAccount,
      deleteLinearAccount: rpcClient.server.deleteLinearAccount,
      listLinearTeams: rpcClient.server.listLinearTeams,
      listLinearProjects: rpcClient.server.listLinearProjects,
      listLinearMappings: rpcClient.server.listLinearMappings,
      upsertLinearMappings: rpcClient.server.upsertLinearMappings,
      listLinearTeamReviewStateMappings: rpcClient.server.listLinearTeamReviewStateMappings,
      upsertLinearTeamReviewStateMappings: rpcClient.server.upsertLinearTeamReviewStateMappings,
      listLinearIssues: rpcClient.server.listLinearIssues,
      startLinearIssueRun: rpcClient.server.startLinearIssueRun,
      listLinearIssueRuns: rpcClient.server.listLinearIssueRuns,
      cancelLinearIssueRun: rpcClient.server.cancelLinearIssueRun,
    },
  };
}
